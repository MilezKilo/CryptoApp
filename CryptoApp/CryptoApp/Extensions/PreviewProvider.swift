...
//В данном файте создаем расширение к Холсту-Превью, а так же поддельные шаблонные данные для отображения.

extension PreviewProvider {
    ///Свойство Превью, через которое можно получить доступ к созданному шаблону.
...
class DeveloperPreview {
    ...
    //Создаем приватный инициализатор, для того, чтобы нельзя было создать новый экземпляр данного класса.
    private init() { }
    
    let homeVM = HomeViewModel()
    let stat1 = StatisticModel(title: "Market Cup", value: "12.5Bn", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "1.23Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "50.3k", percentageChange: -12.41)
    
    //Создание шаблона для отображения в Превью
    let coin = CoinModel(
        id: "bitcoin",
        symbol: "btc",
        name: "Bitcoin",
