...
/*
 ...
 //Ответ получаемый с сервера coingecko
 JSON Response:
 {
     "id": "bitcoin",
     "symbol": "btc",
...
///Структура данных, полученная с сервера, создана с помощью сервиса app.quicktype.io
struct CoinModel: Identifiable, Codable {
    ...
    ///Ключи для кодирования/декодирования JSON данных.
    ...
    ///Метод обновляющий содержащиеся в портфеле данных.
    ...
    ///Свойство, содержит в себе текущее количество валюты, или же возвращает 0, тк currentHoldings опциональное.
    var currentHoldingsValue: Double {
        return (currentHoldings ?? 0) * currentPrice
    }
    
    ///Возвращает рейтинг рыночной капитализации
    var rank: Int {
